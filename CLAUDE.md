...
Pace Downloader - A full-stack web app with a FastAPI backend and SvelteKit frontend that automates downloading One Pace episodes (fan-edited One Piece anime) via qBittorrent and places them in the correct media structure for Jellyfin media server.
